package ru.mirea.shlobin.audiorecord;
...
import ru.mirea.shlobin.audiorecord.databinding.ActivityMainBinding;
какие разрешения нужны для работы акселерометра
        где они задаются
